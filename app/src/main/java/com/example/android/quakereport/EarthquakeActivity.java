...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    //Made it global so both members of EarthquakeAsyncTask class can access (and modify) it too.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //It can take any number of comma-separated Url Strings. Here it is just one: USGS_REQUEST_URL.
